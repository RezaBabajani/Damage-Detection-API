...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/hub/yolov5l6', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/test_train_mai2022.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/car_damage.yaml', help='hyperparameters path')
